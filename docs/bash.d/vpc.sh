...
_vpc_hostif_create()
{
    ...
    flags+=("--hostif-id=")
    two_word_flags+=("-H")
    local_nonpersistent_flags+=("--hostif-id=")
    flags+=("--log-format=")
    two_word_flags+=("-F")
    flags+=("--log-level=")
    two_word_flags+=("-l")
...
_vpc_switch_port_set()
{
    last_command="vpc_switch_port_set"
    commands=()
